...
<body >
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in" style="margin-left: 0px;">
            <h1><?=$data['name']?></h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4" data-aos="fade-right">
                        <img src="assets/img/<?=$data['profilepic']?>" style="border-radius: 10px;" class="img-fluid" alt="">
                    </div>
...
-->
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="copyright">
                &copy; Copyright <strong><span>rmtechit</span></strong>
            </div>

            <div class="credits">
                Developed by <a href="https://www.facebook.com/mdmominul.islam.79230305/">devlopermiredoy</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
